...
export const getInitialTheme = (themeConfig) => {
  ...
  if (
    ...
    const theme = localStorage.getItem('gitprofile-theme');
...
export const skeleton = ({
  ...
  return (
    <div
      className={`animate-pulse ${shape}${className ? ` ${className}` : ''}${
        width ? ` ${width}` : ''
      }${height ? ` ${height}` : ''}`}
      style={style}
    />
